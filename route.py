...
def print_information(start, station1, station2, finish):
    ...
    print("Walk {0:.2f}km from {1} to {2}, {3} seconds".format(distance_on_earth(start, station1), start, station1, travel_time(start, station1, "walking")))
    print(GoogleDirections.Directions("{!s},{!s}".format(start[0], start[1]), "{!s},{!s}".format(station1[0], station1[1]), "walking"))
    print("\n")
...
timeWithSeconds = travel_time(start, station1, "walking") + travel_time(station1, station2, "bicycle") + travel_time(station2, finish, "walking")
